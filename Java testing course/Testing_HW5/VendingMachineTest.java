...
class VendingMachineTest {
    ...
    */
    ...
    @Test
    void giveProduct1CorrectMaxProducts() {
        vm.enterAdminMode(adminCode);
        vm.fillProducts();
        vm.fillCoins(1, 1);
        vm.setPrices(3, 2);
        vm.exitAdminMode();
        IntStream.rangeClosed(1, max1).forEach(j -> assertEquals(VendingMachine.Response.OK, vm.putCoin1()));
        IntStream.rangeClosed(1, max1).forEach(j -> assertEquals(VendingMachine.Response.OK, vm.putCoin2()));
        assertEquals(VendingMachine.Response.OK, vm.giveProduct1(max1));
    }
    ...
    @Test
    void giveProduct2CorrectMaxProducts() {
        vm.enterAdminMode(adminCode);
        vm.fillProducts();
        vm.fillCoins(1, 1);
        vm.setPrices(4, 3);
        vm.exitAdminMode();
        IntStream.rangeClosed(1, max2).forEach(j -> assertEquals(VendingMachine.Response.OK, vm.putCoin1()));
        IntStream.rangeClosed(1, max2).forEach(j -> assertEquals(VendingMachine.Response.OK, vm.putCoin2()));
        assertEquals(VendingMachine.Response.OK, vm.giveProduct2(max2));
    }
